...
@Configurable
public class SearchFormMulitQueryBuidName2Test {

	private static final Logger logger = LoggerFactory.getLogger(SearchFormMulitQueryBuidName2Test.class);
	...
	public void searchParentAliasTest() throws ParseException {
		...
		String corpNameFrom = "BUID0001";
		String corpNameTo = "BUID0002";
		String dateFrom = "";
		String dateTo = "";

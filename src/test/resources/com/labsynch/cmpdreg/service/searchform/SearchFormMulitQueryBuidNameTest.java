...
@Configurable
public class SearchFormMulitQueryBuidNameTest {

	private static final Logger logger = LoggerFactory.getLogger(SearchFormMulitQueryBuidNameTest.class);

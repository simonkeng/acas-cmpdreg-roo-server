...
@Configurable
public class SearchFormMulitQuery4Test {

	private static final Logger logger = LoggerFactory.getLogger(SearchFormMulitQuery4Test.class);
	...
	public void searchParentAliasTest() throws ParseException {
		...
		String corpNameFrom = "CMPD-1202-0";
		String corpNameTo = "";
		String dateFrom = "";
		String dateTo = "";

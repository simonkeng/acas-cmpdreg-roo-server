...
public class V1_0_4_4__Add_standardization_jchem_tables implements JdbcMigration {
 
	Logger logger = LoggerFactory.getLogger(V1_0_4_4__Add_standardization_jchem_tables.class);

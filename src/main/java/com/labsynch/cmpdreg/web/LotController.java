...
//    }
	...
	@RequestMapping(params = "find=ByBuid", method = RequestMethod.GET, headers = "Accept=application/json")
    @ResponseBody
    public ResponseEntity<String> jsonFindLotsByBuid(@RequestParam("buid") long buid) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/text; charset=utf-8");
        return new ResponseEntity<String>(Lot.toJsonArray(Lot.findLotsByBuid(buid).getResultList()), headers, HttpStatus.OK);
    }

	@RequestMapping(params = "find=ByChemistAndSynthesisDateBetween", method = RequestMethod.GET, headers = "Accept=application/json")
    @ResponseBody
    public ResponseEntity<String> jsonFindLotsByChemistAndSynthesisDateBetween(@RequestParam("chemist") Scientist chemist, @RequestParam("minSynthesisDate")  Date minSynthesisDate, @RequestParam("maxSynthesisDate") Date maxSynthesisDate) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/text; charset=utf-8");
        return new ResponseEntity<String>(Lot.toJsonArray(Lot.findLotsByChemistAndSynthesisDateBetween(chemist, minSynthesisDate, maxSynthesisDate).getResultList()), headers, HttpStatus.OK);
    }

	@RequestMapping(params = "find=ByCorpNameEquals", method = RequestMethod.GET, headers = "Accept=application/json")
    @ResponseBody
    public ResponseEntity<String> jsonFindLotsByCorpNameEquals(@RequestParam("corpName") String corpName) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/text; charset=utf-8");
        return new ResponseEntity<String>(Lot.toJsonArray(Lot.findLotsByCorpNameEquals(corpName).getResultList()), headers, HttpStatus.OK);
    }

	@RequestMapping(params = "find=ByCorpNameLike", method = RequestMethod.GET, headers = "Accept=application/json")
    @ResponseBody
    public ResponseEntity<String> jsonFindLotsByCorpNameLike(@RequestParam("corpName") String corpName) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/text; charset=utf-8");
        return new ResponseEntity<String>(Lot.toJsonArray(Lot.findLotsByCorpNameLike(corpName).getResultList()), headers, HttpStatus.OK);
    }

	@RequestMapping(params = "find=ByIsVirtualNot", method = RequestMethod.GET, headers = "Accept=application/json")
    @ResponseBody
    public ResponseEntity<String> jsonFindLotsByIsVirtualNot(@RequestParam(value = "isVirtual", required = false) Boolean isVirtual) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/text; charset=utf-8");
        return new ResponseEntity<String>(Lot.toJsonArray(Lot.findLotsByIsVirtualNot(isVirtual == null ? new Boolean(false) : isVirtual).getResultList()), headers, HttpStatus.OK);
    }

	@RequestMapping(params = "find=ByNotebookPageEquals", method = RequestMethod.GET, headers = "Accept=application/json")
    @ResponseBody
    public ResponseEntity<String> jsonFindLotsByNotebookPageEquals(@RequestParam("notebookPage") String notebookPage) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/text; charset=utf-8");
        return new ResponseEntity<String>(Lot.toJsonArray(Lot.findLotsByNotebookPageEquals(notebookPage).getResultList()), headers, HttpStatus.OK);
    }

	@RequestMapping(params = "find=ByNotebookPageEqualsAndIgnoreNot", method = RequestMethod.GET, headers = "Accept=application/json")
    @ResponseBody
    public ResponseEntity<String> jsonFindLotsByNotebookPageEqualsAndIgnoreNot(@RequestParam("notebookPage") String notebookPage, @RequestParam(value = "ignore", required = false) Boolean ignore) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/text; charset=utf-8");
        return new ResponseEntity<String>(Lot.toJsonArray(Lot.findLotsByNotebookPageEqualsAndIgnoreNot(notebookPage, ignore == null ? new Boolean(false) : ignore).getResultList()), headers, HttpStatus.OK);
    }

	@RequestMapping(params = "find=BySaltForm", method = RequestMethod.GET, headers = "Accept=application/json")
    @ResponseBody
    public ResponseEntity<String> jsonFindLotsBySaltForm(@RequestParam("saltForm") SaltForm saltForm) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/text; charset=utf-8");
        return new ResponseEntity<String>(Lot.toJsonArray(Lot.findLotsBySaltForm(saltForm).getResultList()), headers, HttpStatus.OK);
    }

	@RequestMapping(params = "find=BySynthesisDateBetween", method = RequestMethod.GET, headers = "Accept=application/json")
    @ResponseBody
    public ResponseEntity<String> jsonFindLotsBySynthesisDateBetween(@RequestParam("minSynthesisDate")  Date minSynthesisDate, @RequestParam("maxSynthesisDate") Date maxSynthesisDate) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/text; charset=utf-8");
        return new ResponseEntity<String>(Lot.toJsonArray(Lot.findLotsBySynthesisDateBetween(minSynthesisDate, maxSynthesisDate).getResultList()), headers, HttpStatus.OK);
    }

	@RequestMapping(params = "find=BySynthesisDateGreaterThan", method = RequestMethod.GET, headers = "Accept=application/json")
    @ResponseBody
    public ResponseEntity<String> jsonFindLotsBySynthesisDateGreaterThan(@RequestParam("synthesisDate")  Date synthesisDate) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/text; charset=utf-8");
        return new ResponseEntity<String>(Lot.toJsonArray(Lot.findLotsBySynthesisDateGreaterThan(synthesisDate).getResultList()), headers, HttpStatus.OK);
    }

	@RequestMapping(params = "find=BySynthesisDateLessThan", method = RequestMethod.GET, headers = "Accept=application/json")
    @ResponseBody
    public ResponseEntity<String> jsonFindLotsBySynthesisDateLessThan(@RequestParam("synthesisDate") Date synthesisDate) {
//		@DateTimeFormat(style = "S-") 
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/text; charset=utf-8");
        return new ResponseEntity<String>(Lot.toJsonArray(Lot.findLotsBySynthesisDateLessThan(synthesisDate).getResultList()), headers, HttpStatus.OK);
    }
}
